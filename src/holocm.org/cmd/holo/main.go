...
func main() {
	...
	var command func([]holo.Entity, map[int]bool)
...
func commandApply(entities []holo.Entity, options map[int]bool) {
	AcquireLockfile()
...
func commandScan(entities []holo.Entity, options map[int]bool) {
